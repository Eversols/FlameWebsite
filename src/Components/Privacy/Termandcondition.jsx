            ...
            <Box sx={mainContainer}>
                <Box>
                    ...
                    >
                        ...
                        <div style={{ marginTop: "20px", marginBottom: "20px" ,lineHeight:"26px"}}>
                        ...
                        <p>{t("1. You are an individual (i.e., not any body corporate, partnership or other business entity) at least 18 years old;")} </p>
                       <p>{t("2. You are not prohibited by law from using our Services;")}</p>
                       <p>{t("  3. You have not committed, been convicted of, or pled no contest to a felony or indictable offense (or crime of similar severity), a sex crime, or any crime involving violence or a threat of violence, unless you have received clemency for a non-violent crime and we have determined that you are not likely to pose a threat to other users of our Services;")}</p>
                        <p>{t(" 4. You are not required to register as a sex offender with any state, federal or local sex offender. ")}</p>
                        </div>
                    </Typography>
                </Box>
            </Box>
